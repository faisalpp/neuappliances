const {NEU_ZIPCODE_API_KEY,NEU_ZIPCODE_API_HOST} = require('../config/index')
const axios = require('axios')

async function zipTransform (zipCode) {
   const options = {
    method: 'GET',
    ...
    headers: {
      'X-RapidAPI-Key': NEU_ZIPCODE_API_KEY,
      'X-RapidAPI-Host': NEU_ZIPCODE_API_HOST
    }
  };
    let data;
    let raw;
