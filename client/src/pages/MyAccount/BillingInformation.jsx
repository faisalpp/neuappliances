...
import {GetBillingAddress,updateBillingAddress} from '../../api/user/profile'
...
const BillingInformationData = () => {
    ...
    return (
        <>
            <form onSubmit={HandleBillingAddress} className='lg:max-w-[432px] w-full flex flex-col gap-6'>
             ...
             <button type='submit'  className='flex justify-center items-center rounded-lg bg-b3 py-3 w-full text-white text-xs font-medium'>{loading ? <BtnLoader style="w-4" />:'Save Changes'}</button>
            </form>
        </>
    )
}
