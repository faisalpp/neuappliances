        ...
        <div className='flex flex-col space-y-10 items-center pt-20 px-5 py-32 w-full' >
          ...
          <form onSubmit={Login} className='flex flex-col space-y-5 max-w-[633px] w-full px-10 py-10 rounded-2xl bg-white border-[1px] border-gray-200' >
            ...
            <div className='flex flex-col space-y-1' >
              ...
              <input type="email" value={email} onChange={()=>setEmail(e.target.value)} className='text-sm outline-none border-[1px] border-gray-200 w-full px-4 py-3 rounded-md' placeholder='youremail@mail.com' />
            </div>
            <div className='flex flex-col space-y-1' >
              ...
              <input type="password" value={password} onChange={()=>setPassword(e.target.value)} className='text-sm outline-none border-[1px] border-gray-200 w-full px-4 py-3 rounded-md' placeholder='youremail@mail.com' />
            </div>
