        ...
        <MainLayout>
            <div className='py-10 lg:py-16 xl:py-20 maincontainer' >
                ...
                <div className='hidden md:flex items-center' >
                    <h5 className='text-xs text-b3' >Home</h5><RiArrowDropRightLine className='text-xl text-b19' /><h5 className='text-xs text-b3' >Help & Support Center</h5><RiArrowDropRightLine className='text-xl text-b19' /><h5 className='text-xs text-black' >Warranty & Return</h5>
                </div>
                {/* Bread Crumbs End */}


                <div className='max-w-[960px] pt-20 mx-auto'>
                    <h1 className='text-32px maxmd:text-center font-bold text-b16'>Warranty & Return</h1>
                    ...
                    <div className='rounded-2xl bg-b8 p-10'>
                        ...
                        <div className='mb-5'>
                            <label htmlFor="reason_return" className='block text-xs text-b18/50 mb-2 font-bold'>Reason for Return</label>
                            <input type="text" name='reason_return' className='w-full bg-white h-10 rounded-lg text-black px-4 text-xs outline-none' placeholder='yourusername@email.com' />
                        </div>
                        <div className='mb-5'>
                            <label htmlFor="refundmethod" className='block text-xs text-b18/50 mb-2 font-bold'>Select a Return Method</label>
                            <select name="refundmethod" className='w-full bg-white h-10 rounded-lg text-black px-4 text-xs outline-none' id="refundmethod">
...
export default WarantyAndRefund