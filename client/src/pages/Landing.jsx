  ...
  return (
    <>
      ...
      <div className='py-10 lg:py-14 xl:py-20 w-full 3xl:max-w-1680px px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto'>
        <ReviewSlider color="#F5F5F5" clientreviews={clientreviews} icon="google.webp" />
      </div>
      <div className='py-10 lg:py-14 xl:py-20 w-full 3xl:max-w-1680px px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto'>
