    ...
    return (
        ...
        <div className='mb-3' ><BsFillArrowLeftCircleFill className='text-2xl text-b3 cursor-pointer' onClick={()=>navigate(-1)} /></div>
         ...
         <div className='relative rounded-2xl border border-gray-300 p-3 h-fit w-[200px] flex justify-center items-center self-center'>
           ...
           {imagePrev !== 'https://placehold.co/600x400' ? <div className='absolute right-1 top-1' ><div onClick={()=>{setImage('');setImagePrev('https://placehold.co/600x400')}} className='flex justify-end w-full bg-white rounded-full' ><AiFillPlusCircle  className='text-red-500 text-xl shadow-xl rounded-full cursor-pointer' /></div></div>:null}
