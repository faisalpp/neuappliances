            ...
            <div className='py-6 pr-7 2xl:pr-12 bg-white border-[1px] border-b3 rounded-xl w-full' >
                <div className='flex flex-col 2xl:flex-row xl:flex-row gap-4 xl:gap-0 items-start w-full'>
                    ...
                    <div className='grid grid-cols-1 2xl:pl-7 2xl:p-0 gap-4 w-full' >
                        ...
                        <ul className='flex flex-col gap-y-3 text-black text-[11px] w-full' >
                        ...
                        <div className='flex flex-col'>
                            ...
                            <div className='flex flex-wrap gap-2 mt-2' >
                                <div className='flex items-center gap-x-2 border border-b14 w-fit rounded-lg px-3 py-2' ><StackableSvg /><h5 className='text-xs xl:text-[10px] font-medium' >STACKABLE</h5></div>
                                <div className='flex items-center gap-x-2 border border-b14 w-fit rounded-lg px-3 py-2' ><SteamSvg /><h5 className='text-xs xl:text-[10px] font-medium' >STEAM</h5></div>
                                <div className='flex items-center gap-x-2 border border-b14 w-fit rounded-lg px-3 py-2' ><GasSvg /><h5 className='text-xs xl:text-[10px] font-medium' >GAS</h5></div>
                            </div>
                        </div>
                    </div>
                </div>
