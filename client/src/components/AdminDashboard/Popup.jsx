...
const Popup = ({state,setState,children,width,zindex}) => {
  return (
    <div className={`fixed ${state?'flex':'hidden'} items-center justify-center top-0 ${zindex?zindex:'z-50'} h-screen bg-black/50 w-full`} >
