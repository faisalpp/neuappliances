...
const CosmaticRatingHowItwork = () => {
    return (
        <div className='grid grid-cols-1 gap-60px'>
            ...
            <p className='max-w-[896px] w-full mx-auto mt-4 text-black text-center'>
            ...
            <SatisfiedSection title="Our Customers Are RAVING About Our Rating System" SectionStyle="!p-0 !max-w-full" />
        </div>
    )
}
