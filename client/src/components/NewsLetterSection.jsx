      ...
      <div className='flex justify-center items-center h-auto py-10 lg:py-16 maincontainer' >
        ...
        <div id="news-grid">
          ...
          <div className='col-start-7 col-end-12 flex flex-col space-y-2 [&>*]:text-b16' >
            ...
            <p className='text-xs xl:w-[350px] w-[280px]' >Sign up above to get updates delivered directly to your inbox. See our <Link to="/privacy-policy" className='font-semibold underline'>Privacy Policy.</Link></p>
          </div>
        </div>
      </div>
    </div>
