...
const NewsLetterSection = ({ backimage }) => {
  return (
    <div id="news" className='flex justify-center items-center h-auto py-10 lg:py-16 3xl:max-w-1680px px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto w-full relative' >
