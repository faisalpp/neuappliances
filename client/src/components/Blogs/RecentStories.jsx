...
const RecentStories = ({load,data,trigger}) => {
    ...
    return (
        <div className='pb-10 lg:pb-16 xl:pb-20 pt-5 w-full 3xl:max-w-1680px px-4 sm:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto'>
            ...
            <div className='flex justify-center'>
                <button type="button" onClick={trigger} className='px-4 py-3 rounded-lg border bg-b3 text-white border-b3 hover:bg-white hover:text-b3 font-medium duration-300 text-xs'>{load ? <img src="loader-bg.gif" /> : 'Read More'}</button>
