        ...
        <div className='grid grid-cols-1 lg:grid-cols-[560px_auto] gap-14'>
            ...
            <div>
                ...
                <div className='flex items-center gap-7 my-8'>
                    ...
                    <span className='text-b16'>WF45B6300AC</span>
                </div>
                <ul className='list-disc ml-6 leading-8 mb-5'>
                    <li className='text-black'>Lorem ipsum dolor alter miler amigos</li>
                    <li className='text-black'>Lorem ipsum dolor alter miler amigos</li>
                    <li className='text-black'>Lorem ipsum dolor alter miler amigos</li>
                    <li className='text-black'>Lorem ipsum dolor alter miler amigos</li>
                </ul>
                <div className='w-full flex flex-col gap-[10px]'>
                    <div className='flex items-center justify-between bg-[#F8F8F8] p-5 rounded-2xl'>
                        <h3 className='text-sm capitalize'><span className='font-semibold'>5 Star</span> rating</h3>
                        <div className='text-sm capitalize'><span className='font-semibold'>3</span> buying options</div>
                        ...
                        <div className='text-b16 font-semibold text-xs px-3 py-[5px] bg-b4 flex items-center rounded-full'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="13" height="12" viewBox="0 0 13 12" fill="none">
                                <mask id="mask0_2_10877" style={{ maskType: "alpha" }} maskUnits="userSpaceOnUse" x="0" y="0" width="13" height="12">
                                    <rect x="0.335938" width="12" height="12" fill="#D9D9D9" />
                                </mask>
                        ...
                        <div className='text-b3 text-xl font-body'>$1,249.00</div>
                    </div>
                    <div className='flex items-center justify-between bg-[#F8F8F8] p-5 rounded-2xl'>
                        <h3 className='text-sm capitalize'><span className='font-semibold'>4 Star</span> rating</h3>
                        <div className='text-sm capitalize'><span className='font-semibold'>12</span> buying options</div>

                        <div className='w-120px bg-black/[0.08] rounded-lg' ><span className='flex rounded-lg bg-gradient-to-r from-b4 to-b7 w-1/3 h-2' ></span></div>
                    ...
                    <div className='flex items-center justify-between bg-[#F8F8F8] p-5 rounded-2xl'>
                        <h3 className='text-sm capitalize'><span className='font-semibold'>3 Star</span> rating</h3>
                        <div className='text-sm capitalize'><span className='font-semibold'>5</span> buying options</div>

                        <div className='w-120px bg-black/[0.08] rounded-lg' ><span className='flex rounded-lg bg-gradient-to-r from-b4 to-b7 w-1/2 h-2' ></span></div>
