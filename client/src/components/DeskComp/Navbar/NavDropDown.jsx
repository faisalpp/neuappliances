...
const NavDropDown = ({ title, links, icon, bold }) => {
  ...
  return (
    <Menu as="div" className="relative" >
      ...
      <Menu.Items as="div" className="absolute z-[100] top-12 -right-8 rounded-sm py-5 bg-white w-32 h-auto text-black font-medium shadow-[0px_4px_40px_0px_rgba(0,0,0,0.08)]">
