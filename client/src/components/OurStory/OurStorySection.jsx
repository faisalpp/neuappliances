        ...
        <>
            <div className='py-10 lg:py-16 xl:py-20 2xl:py-100px bg-b8'>
                <div className='max-w-[572px] flex flex-col mx-auto text-center gap-5'>
                    ...
                    <p className='text-base sm:text-xl sm:leading-[30px]'>
                        Egestas nulla mauris elit at sed gravida. Donec neque nulla nisi nulla. Vel cras purus tempor ultricies amet. Bibendum sit sit.
                    </p>
                </div>
            </div>
        </>
