  ...
  return (
    <>
      <div className='relative flex flex-col m-0 items-center rounded-xl justify-center p-5 2xl:p-7 3xl:p-10 bg-white shadow-lg' >
        ...
        <h3 className={`text-lg xl:text-xl 3xl:text-2xl ${txtStyle} mb-8 font-semibold lg:text-lg text-center`} >{title}</h3>
        <div className='absolute bottom-5 2xl:bottom-7 3xl:bottom-10 flex justify-center items-center'>
          <Modal icon={img} title={title} description={description} note={note} buttonName={`Learn More <svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
        ...
        </svg>`} buttonClass="text-b7 font-semibold flex justify-center items-center gap-1" />
        </div>
      </div>
    </>
  )
