...
const ProductsTypeCard = ({ productstype }) => {
    // console.log(`${import.meta.env.REACT_APP_INTERNAL_PATH}/storage/categories/1687645353244-Refrigerators.png`)
    return (
        <>
            <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8'>
                {productstype.map((product, index) => (
                    <div key={index}>
                        <div className='rounded-3xl border border-gray-300 p-7 2xl:p-[30px] relative overflow-hidden group maxmd:max-w-[330px] maxmd:mx-auto'>
