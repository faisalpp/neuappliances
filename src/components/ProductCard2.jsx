...
const ProductCard2 = () => {
  return (
    <div className='relative flex flex-col border-2 border-gray-100 rounded-lg bg-white ' >
      <span className='absolute right-0 bg-b4 rounded-xl mt-2 mr-1 px-4 py-[3px] text-xs font-bold ' >50% Off</span>
      <img src="p1.png" className='min-w-[265px] w-[500px] h-full' />
