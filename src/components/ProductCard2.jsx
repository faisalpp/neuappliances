...
const ProductCard2 = ({stars}) => {
  ...
  return (
    <>
    <div className='relative flex flex-col border-2 border-gray-100 rounded-lg bg-white py-10 xl:w-[330px] xl:h-[555px] px-9' >
      <span className='absolute top-0 right-0 bg-b4 rounded-2xl mt-2 mr-1 px-4 py-2 text-xs font-bold ' >50% Off</span>
      <div className='flex w-full justify-center' ><img src="p1.png" className=' w-52 h-full' /></div>
