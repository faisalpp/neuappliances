...
const WwslSection = () => {
  return (
    <>
          ...
          <div className='flex flex-col pb-16 pt-10 bg-b8 w-full' >
          <h4 className='text-center font-bold text-4xl mt-16' >What We Sell</h4>
          <div className='lg:grid 2xl:grid xl:grid md:grid grid-flow-col w-full space-x-2  lg:space-y-0 md:space-y-0 space-y-5 px-[8.33%] mt-16 mb-5' >
