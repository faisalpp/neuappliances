...
const ProductSlider = () => {
  return (
    ...
    <Slider>
      <Slide index={0}>
        <div className='flex w-full justify-center' ><img src="p1.png" className='xl:w-3/2 lg:w-44 w-40 h-full' /></div>
      </Slide>
      <Slide index={1}>
      <div className='flex w-full justify-center' ><img src="p1.png" className='xl:w-3/2 lg:w-44 h-full' /></div>
      </Slide>
      <Slide index={2}>
      <div className='flex w-full justify-center' ><img src="p1.png" className='xl:w-3/2 lg:w-44 h-full' /></div>
      </Slide>
