...
const ReviewCard = ({color}) => {
  return (
    <div style={{backgroundColor:color}} className='flex flex-col shadow-sm px-5 py-3 rounded-xl xl:min-w-[342px] xl:h-[170px] lg:min-w-[320px]' >
      ...
      <div className='flex items-center' ><h5 className='text-sm mt-2 w-10/12' >John Doe</h5><img src="google.png" className='h-5 w-10 mt-4' /></div>
    </div>
  )
}
