  ...
  return (
    <div className='flex flex-col maxmd:max-w-[330px] relative maxmd:mx-auto bg-white w-full h-auto rounded-md p-4 sm:p-6 md:p-8 lg:p-6 shadow-md' >
      ...
      <div className='flex flex-col items-center justify-center mt-6 w-full' >
        <div className='flex justify-center items-center text-center gap-x-1 text-[#242424] text-sm sm:text-base 2xl:text-[22px]' ><h4 className='font-bold' >{title}:</h4><span className='font-medium' >{product.rating} star</span></div>
        <div className='flex gap-x-3 mb-4' ><StarIconPrinter numberOfTimes={product.rating} /></div>
        {product.rating === '3' ? <h4 className='text-b3 font-semibold text-sm 2xl:text-base' >Moderate Cosmetic Damage</h4> : null}
        {product.rating === '4' ? <h4 className='text-b3 font-semibold text-sm 2xl:text-base' >Minor Cosmetic Damage</h4> : null}
        {product.rating === '5' ? <h4 className='text-b3 font-semibold text-sm 2xl:text-base' >very Minor To No Cosmetic Damage</h4> : null}
