...
const ReviewExCard = ({color}) => {
  return (
    <div style={{backgroundColor:color}} className='flex flex-col xl:space-y-6 shadow-sm lg:px-10 xl:px-10 px-4 py-3 rounded-xl xl:min-w-[464px] xl:min-h-[300px]  lg:min-w-[420px] lg:min-h-[200px] xl:w-[450px] h-56 min-w-[250px]' >
