...
const ReviewExCard = ({color}) => {
  return (
    <div className={`flex flex-col xl:space-y-6 bg-b7/10 shadow-sm lg:px-10 xl:px-10 px-4 py-8 rounded-2xl xl:min-w-[472px] xl:min-h-[280px]  lg:min-w-[430px] lg:min-h-[200px] h-38 min-w-[350px]`} >
