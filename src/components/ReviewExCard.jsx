...
const ReviewExCard = ({color}) => {
  return (
    <div style={{backgroundColor:color}} className='flex flex-col xl:space-y-6 shadow-sm lg:px-10 xl:px-10 px-4 py-3 rounded-xl xl:min-w-[472px] xl:min-h-[280px]  lg:min-w-[430px] lg:min-h-[200px] h-56 min-w-[250px]' >
