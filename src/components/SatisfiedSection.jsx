...
const SatisfiedSection = ({ title, dots }) => {
  ...
  return (
    <div className={`flex flex-col justify-center max-w-1680px px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-[112px] mx-auto py-10 lg:py-16 xl:py-20 2xl:py-120px ${dots ? 'mb-7' : ''}`} >
