...
const HeroSection = () => {
  return (
    <>
          <div className='lg:grid 2xl:grid xl:grid md:grid space-x-10 flex flex-col lg:space-y-0 space-y-10 grid-cols-12 items-center py-20 px-[8.33%] bg-b5 auto' >
          ...
          <div className='col-start-8 col-end-12 flex justify-center' >
            <div className='relative' >
              ...
              <iframe className='xl:w-[550px] xl:h-[504px] lg:h-96 lg:w-[430px] h-52 w-80 rounded-2xl ' src="https://www.youtube.com/embed/OzCAGd4YVbI" title="Introducing our Next Generation of High End Kitchen Appliances | Miele" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
          </div>
        </div>
    </>
