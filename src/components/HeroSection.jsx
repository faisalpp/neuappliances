...
const HeroSection = () => {
  return (
    <>
          <div className='lg:grid flex flex-col lg:space-y-0 space-y-10 lg:grid-cols-12 2xl:grid-cols-12 items-center py-20 lg:px-10 px-5 bg-b5 auto' >
          <div className='col-start-1 col-end-7 flex flex-col space-y-10' >
           <h4 className='xl:text-6xl lg:text-5xl text-3xl lg:text-start text-center font-bold' >Austin's Best Deals For Scratch & Dent Appliances</h4>
