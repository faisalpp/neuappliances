...
const TourSection = () => {
  return (
    <div id="tour" className='xl:grid lg:grid grid-cols-12 xl:gap-x-10 lg:space-x-16 flex flex-col items-center justify-center xl:px-[120px] lg:px-[80px] lg:py-16 py-10' >
    ...
    {/* <div className=' flex flex-col items-center lg:mt-0 mt-5 h-full' > */}
      <div className='col-start-6 col-end-13 bg-white rounded-xl shadow-xl xl:w-[760px] xl:h-[640px] lg:pb-0 py-5 lg:w-11/12 h-full xl:px-[80px] px-10 flex flex-col space-y-5 justify-center xl:mt-0 lg:mt-0 mt-5' >
