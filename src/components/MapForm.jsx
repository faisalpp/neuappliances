...
const MapForm = ({zip,setZip,Submit,success,error}) => {
  ...
  return (
      <div className='absolute left-20 lg:flex hidden xl:h-[543px] xl:w-[512px] lg:h-[420px] lg:w-[350px] h-fit py-10  w-[380px] rounded-2xl bg-white bg-opacity-30 backdrop-blur-lg  shadow-2xl z-30 ' >
