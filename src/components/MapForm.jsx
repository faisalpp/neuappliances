    ...
    <div className='absolute left-20 lg:flex hidden h-fit py-10 w-[380px] rounded-2xl bg-white shadow-2xl z-30 ' >
      <div className='flex flex-col  justify-center px-10 space-y-5' >
       ...
       <div className='flex flex-col space-y-1 bg-b7 px-4 py-4 rounded-lg' >
        ...
        <div className='flex justify-center' ><a className='flex items-center cursor-pointer bg-b12 w-full px-4 py-2 justify-center space-x-2 rounded-2xl text-white font-semibold' ><AiOutlineCheckCircle className='text-sm' /><span className='text-xs' >Delivery Available</span></a></div>
