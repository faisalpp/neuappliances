...
const Navbar = ({setSCart}) => {
  ...
  return (
    <>
    <div className='lg:hidden grid grid-cols-12 bg-b1 text-white py-4 px-2' >
      <img src="neu.png" className='col-start-1 px-2 col-end-4 w-24 h-10' />
      ...
      <div className='col-start-10 col-end-12 space-x-4 flex items-center' >
