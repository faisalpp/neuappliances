...
const HiwSection = () => {
  return (
    <div className='flex flex-col items-center bg-b8 space-y-10 pb-10 w-full' >
       <h4 className='font-bold xl:text-[36px] text-3xl py-5' >How it Works</h4>
       
    <div className='flex xl:flex-row lg:flex-row md:flex-col lg:items-stretch md:items-center flex-col 2xl:space-x-10 xl:space-x-10 lg:space-x-7 px-[8.33%] justify-evenly w-full' >
