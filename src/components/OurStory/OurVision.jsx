        ...
        <>
            <div className='grid grid-cols-2 gap-10 xl:gap-24 3xl:gap-28 py-10 lg:py-16 xl:py-20 w-full max-w-1680px px-4 sm:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto'>
                ...
                <div className='flex items-center relative'>
                    <div className='absolute top-0 left-0 w-[300px] xl:w-[318px] h-[230px] xl:h-[250px] 3xl:h-[280px] bg-b3/10 rounded-3xl mt-4 -z-10'></div>
                    <div className='flex flex-col gap-3 3xl:gap-5 ml-10'>
