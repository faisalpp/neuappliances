...
const Filter = ({ onClose, isFilter }) => {
    ...
    return (
        <div className={`maxlg:fixed maxlg:bg-black/20 items-end left-0 right-0 lg:w-1/5 z-50 duration-300 ${modalClass}`} onClick={onClose}>
            <div className='lg:flex flex-col w-full maxlg:max-h-[398px] [&>div]:maxlg:px-10 maxlg:pb-10 maxlg:rounded-tl-2xl maxlg:rounded-tr-2xl maxlg:bg-white maxlg:overflow-y-auto' onClick={handleFilterClick}>
