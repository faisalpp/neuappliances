...
const LoopSection = () => {
  ...
  return (
    <div className='flex flex-col mt-10 xl:px-[120px] lg:px-[60px]' >
    ...
    <iframe className='col-start-1 col-end-6 w-11/12 rounded-2xl xl:h-[651px] xl:w-[1440px] lg:w-[1100px] h-72 lg:h-[430px]' src={video} title="Introducing our Next Generation of High End Kitchen Appliances | Miele" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      <div>
