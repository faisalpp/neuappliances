        ...
        <div className='flex flex-col mt-5 rounded-lg px-4 py-5 border-[1px] border-gray-200 ' >
          <h4 className='font-semibold' >Delivery Orders</h4>
           ...
           <div className='flex justify-start mt-3 ' >
             <img src="p1.png" className='w-20 h-[70px]' />
             <div className='flex' >
           ...
           <div className='border-[1px] lg:mt-0 mt-3 border-gray-200 rounded-md py-3 px-3' >
            <div className='flex items-center lg:space-x-32 space-x-20 ' ><div className='flex items-center space-x-1' ><FaDotCircle className='text-b3' /><HiOutlineTruck className='text-2xl' /><h4 className='text-sm font-medium' >Delivering To</h4></div><h4 className='text-b3 font-semibold' >$80</h4></div>
           </div>
