...
const MapSection = () => {
  ...
  return (
    <>
      <h4 className='font-bold text-center text-xl xl:text-3xl lg:text-2xl 2xl:text-4xl mt-10 lg:mt-14 xl:mt-20' >Neu Local Delivery Area</h4>
      <div className='relative flex flex-col lg:grid grid-cols-3 3xl:grid-cols-4 items-center py-10 lg:py-14 xl:py-20 w-full h-full max-w-1680px px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto' >
        ...
        {/* Map Section Start */}
        <div id="map" className='col-span-2 3xl:col-span-3 w-full xl:h-[686px] lg:h-[490px] md:h-[300px] h-52 rounded-2xl' ></div>
        {/* Map Section End */}
