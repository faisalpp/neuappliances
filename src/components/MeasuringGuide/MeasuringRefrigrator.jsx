...
const MeasuringRefrigrator = () => {
    return (
        <div className='flex flex-col gap-14 pb-10 lg:pb-16 xl:pb-20 2xl:pb-120px pt-10 w-full max-w-1680px px-4 sm:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto'>
