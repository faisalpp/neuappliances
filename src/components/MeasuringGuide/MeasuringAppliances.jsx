...
const MeasuringAppliances = () => {
    return (
        <div className='flex flex-col gap-14 py-10 lg:py-16 xl:py-20 2xl:py-120px w-full max-w-1680px px-4 sm:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto bg-b8'>
