  ...
  return (
    ...
    <div className='relative my-8 mx-5' >
     ...
     <div id="id6" className='flex lg:overflow-x-hidden overflow-x-scroll xl:space-x-[9px] space-x-4 lg:space-x-3 scroll-smooth' >
      <img onClick={()=>setState('g2.png')} src="g2.png" className={`xl:h-[142px] xl:w-[171px] cursor-pointer lg:h-[100px] lg:w-[130px] w-36 h-32 ${state === 'g2.png' ? 'xl:border-4 lg:border-2 border-blue-500 rounded-xl' : 'border-none'}  `} />
      ...
      <img onClick={()=>setState('g8.png')} src="g2.png" className={`xl:h-[142px] xl:w-[171px] cursor-pointer lg:h-[100px] lg:w-[130px] w-36 h-32 ${state === 'g8.png' ? 'xl:border-4 lg:border-2 border-blue-500 rounded-xl' : 'border-none'}  `} />
      <img onClick={()=>setState('g8.png')} src="g3.png" className={`xl:h-[142px] xl:w-[171px] cursor-pointer lg:h-[100px] lg:w-[130px] w-36 h-32 ${state === 'g8.png' ? 'xl:border-4 lg:border-2 border-blue-500 rounded-xl' : 'border-none'}  `} />
      <img onClick={()=>setState('g8.png')} src="g5.png" className={`xl:h-[142px] xl:w-[171px] cursor-pointer lg:h-[100px] lg:w-[130px] w-36 h-32 ${state === 'g8.png' ? 'xl:border-4 lg:border-2 border-blue-500 rounded-xl' : 'border-none'}  `} />
      <img onClick={()=>setState('g8.png')} src="g7.png" className={`xl:h-[142px] xl:w-[171px] cursor-pointer lg:h-[100px] lg:w-[130px] w-36 h-32 ${state === 'g8.png' ? 'xl:border-4 lg:border-2 border-blue-500 rounded-xl' : 'border-none'}  `} />
      <img onClick={()=>setState('g8.png')} src="g6.png" className={`xl:h-[142px] xl:w-[171px] cursor-pointer lg:h-[100px] lg:w-[130px] w-36 h-32 ${state === 'g8.png' ? 'xl:border-4 lg:border-2 border-blue-500 rounded-xl' : 'border-none'}  `} />
     </div>
    </div>
