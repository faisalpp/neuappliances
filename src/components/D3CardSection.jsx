...
const D3CardSection = () => {
  ...
  return (
    ...
    <div className='flex items-center py-20 xl:space-x-28 space-x-10 xl:px-[120px] lg:px-[60px]  ' >
     <div className='flex flex-col space-y-5 w-1/2' >
       <div className='flex space-x-2 items-center' ><img src="pig.png" className='h-5' /><p className='text-sm' >We provide our Austin neighbors the best savings on  floor models , returns and scratch and dent appliances. </p></div>
     ...
     <div className='w-1/2 parent-container' >
     <Carousel
        cards={cards}
        height="400px"
        width="70%"
