...
const ProductFeatures = ({ video }) => {
  return (
    <>
      <div className='flex flex-col py-10 lg:py-14 xl:py-20 3xl:max-w-1680px px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto' >
        <div className='flex justify-center items-center flex-col w-full' >
          ...
          <video controls src={`${process.env.REACT_APP_INTERNAL_PATH}/${video}`} className='w-full md:w-3/4 h-[500px] 2xl:w-[1200px] 2xl:h-[565px] mt-14 rounded-2xl object-cover' />
        </div>
      </div>
    </>
  )
