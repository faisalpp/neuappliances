        ...
        <>
            <MainLayout>
                ...
                <div className='flex items-center pt-10 w-full max-w-1680px px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto' >
                    <div className='flex items-center' ><h5 className='text-xs text-b3' >Home</h5><RiArrowDropRightLine className='text-xl text-b3' /><h5 className='text-xs text-gray-500' >Appliances</h5></div>
                </div>
                {/* Bread Crumbs End */}
                <div className='flex flex-col gap-6 items-center text-center py-10 lg:py-16 xl:py-20 max-w-1680px px-4 sm:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto'>
                    <h2 className='text-3xl lg:text-4xl font-bold'>Shop By Appliance Types</h2>
