...
const CreateBlog = () => {
  ...
  return (
    ...
    <JoditFileManager key="blogger" state={popup} setState={setPopup} selectedItem={selectedImage} handleSelection={handleImageSelection} />
        ...
        <div className='flex items-center w-full px-[8.33%]'>
          ...
          <div className='flex w-full' >
           ...
           <div className="flex flex-col w-4/12" >
            ...
            <div className='flex space-x-5' >
             <SelectInput name="type" title="Select Blog Type" iscompulsory="true" onLoad={()=>setType('General Blog')} onChange={handleType} options={['Blog','Appliance Tips','Help & Support']}  />
