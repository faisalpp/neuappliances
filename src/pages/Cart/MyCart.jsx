...
const MyCart = () => {
    ...
    return (
        <>
            <MainLayout>
                {/* Bread Crumbs Start */}
                <div className='pt-10 pb-10 w-full max-w-1680px px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto' >
                ...
                <div className='pb-10 lg:pb-16 xl:pb-20 w-full max-w-1680px px-4 md:px-10 lg:px-16 xl:px-20 2xl:px-120px mx-auto'>
